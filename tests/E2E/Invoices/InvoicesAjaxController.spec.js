...
test.describe('Invoices AJAX — modals', () => {
  test('it renders the create invoice modal', async ({ page }) => {
    ...
    const response = await post(page, '/invoices/ajax/modal_create_invoice', { client_id: String(client.id) });
  ...
  test('it renders the create recurring modal', async ({ page }) => {
    ...
    const response = await post(page, '/invoices/ajax/modal_create_recurring', { invoice_id: String(invoice.id) });
    const body = await response.text();
  ...
  test('it renders the create credit modal', async ({ page }) => {
    ...
    const response = await post(page, '/invoices/ajax/modal_create_credit', { invoice_id: String(invoice.id) });
    const body = await response.text();
