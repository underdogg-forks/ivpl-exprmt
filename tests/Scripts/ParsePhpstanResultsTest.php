...
class ParsePhpstanResultsTest extends AbstractTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        // Simulate CLI invocation: the script reads bare $argc/$argv at its top
        // level. require_once runs in this method's scope, not the true global
        // scope, so $GLOBALS assignment alone isn't enough — bind $argc/$argv
        // into this scope too via `global`, matching what the real CLI SAPI does.
        global $argc, $argv;
        $argc = $GLOBALS['argc'] = 2;
        $argv = $GLOBALS['argv'] = ['parse-phpstan-results.php', $tmpFile];
