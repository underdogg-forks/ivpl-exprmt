...
$lang = [
    ...
    'merchant_client_not_found'      => 'The selected integration provider was not found or is disabled.',
    ...
    // e-invoicing module UI (provider settings, incoming invoices, events, history)
    ...
    'invoice_endpoint'                   => 'Invoice send endpoint',
    'send_invoice_endpoint'              => 'Invoice transmission endpoint',
    'invoice_status_endpoint'            => 'Invoice status endpoint',
    'incoming_invoices_endpoint'         => 'Incoming invoices endpoint',
    'invoice_events_endpoint'            => 'Invoice events endpoint',
    'credit_note_endpoint'               => 'Credit note endpoint',
    'credit_note_status_endpoint'        => 'Credit note status endpoint',
    'participants_endpoint'              => 'Participants endpoint',
    'participant_lookup_endpoint'        => 'Participant lookup endpoint',
    'transmissions_endpoint'             => 'Transmissions endpoint',
    'transmission_status_endpoint'       => 'Transmission status endpoint',
    'documents_endpoint'                 => 'Documents endpoint',
    'document_endpoint'                  => 'Document endpoint',
